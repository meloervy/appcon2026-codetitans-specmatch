    ...
    */
    ...
    'providers' => [
        ...
        'gemini' => [
            ...
            'models' => [
                'text' => [
                    'default' => env('GEMINI_MODEL', 'gemini-3.1-flash-lite'),
                    'smartest' => env('GEMINI_SMARTEST_MODEL', 'gemini-3.1-flash-lite'),
                    'cheapest' => env('GEMINI_CHEAPEST_MODEL', 'gemini-3.1-flash-lite'),
                ],
            ],
        ],
