                            ...
                            {recent_assignments.map((asg) => (
                                <tr key={asg.id} className="hover:bg-slate-50/70 dark:hover:bg-zinc-800/40 transition">
                                    <td className="py-4 px-5">
                                        ...
                                        <div className="text-xs text-slate-500 dark:text-zinc-400 font-medium mt-0.5">{asg.device.brand} {asg.device.model}</div>
                                    </td>
                                    <td className="py-4 px-5 font-bold text-slate-900 dark:text-zinc-100 text-sm">
                                        {asg.employee.name}
                                    </td>
                                    <td className="py-4 px-5">
                                        <div className="text-sm font-semibold text-slate-800 dark:text-zinc-200">{asg.employee.department}</div>
                                    ...
                                    <td className="py-4 px-5 text-xs font-medium text-slate-600 dark:text-zinc-400">
                                        {new Date(asg.assigned_at).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}
                                    </td>
                                </tr>
                            ))}
                        </tbody>
