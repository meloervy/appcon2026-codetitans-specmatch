...
export default function MatchRequest({ employees, role_profiles, recent_requests, selected_employee_id }) {
    ...
    return (
        <AuthenticatedLayout
            header={
                <div>
                    <h1 className="text-2xl font-bold tracking-tight text-slate-900">AI-Powered Matching Engine</h1>
                ...
                <div className="lg:col-span-5 space-y-6">
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200/80 p-6 shadow-xs">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h2 className="font-bold text-slate-900 text-base">Request Specification</h2>
                        </div>
                        ...
                        <div>
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-[11px] text-slate-400">Free-form employee request</span>
                            </div>
                            <textarea
                                rows={4}
                                value={rawInput}
                                ...
                                className="mt-1.5 w-full text-sm rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 placeholder-slate-400"
                            />
                        </div>

                        {/* Quick Prompts */}
                        <div className="mt-3">
                            <span className="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Example Templates:</span>
                            <div className="flex flex-wrap gap-1.5 mt-1.5">
                                {examplePrompts.map((p, idx) => (
                                    <button
                                        ...
                                        className="text-[11px] text-left px-2.5 py-1 rounded-lg bg-slate-50 hover:bg-indigo-50 hover:text-indigo-700 border border-slate-200/60 transition line-clamp-1"
                                    >
                                        {p}
                                    </button>
                                ))}
                        ...
                        <div className="bg-white rounded-2xl border border-indigo-100 p-6 shadow-xs relative overflow-hidden">
                            ...
                            <div className="flex items-center justify-between mb-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    <h3 className="font-bold text-slate-900 text-sm">Extracted Requirement Contract</h3>
                                </div>
                            ...
                            {extracted.reasoning && (
                                <div className="mb-4 p-3 rounded-xl bg-indigo-50/70 border border-indigo-100 text-xs text-indigo-900 leading-relaxed">
                                    <span className="font-bold text-indigo-950">AI Reasoning:</span> {extracted.reasoning}
                                </div>
                            )}
                            ...
                            <div className="space-y-3 text-xs">
                                <div className="grid grid-cols-2 gap-3">
                                    <div>
                                        <label className="text-slate-500 font-semibold uppercase">Min CPU Tier</label>
                                        <select
                                            value={extracted.min_cpu_tier}
                                            onChange={(e) => setExtracted({ ...extracted, min_cpu_tier: e.target.value })}
                                            className="mt-1 w-full text-xs rounded-lg border-slate-200 capitalize font-medium"
                                        >
                                    ...
                                    <div>
                                        <label className="text-slate-500 font-semibold uppercase">Min RAM (GB)</label>
                                        <input
                                            type="number"
                                            value={extracted.min_ram_gb}
                                            onChange={(e) => setExtracted({ ...extracted, min_ram_gb: parseInt(e.target.value) || 0 })}
                                            className="mt-1 w-full text-xs rounded-lg border-slate-200 font-medium"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div>
                                        <label className="text-slate-500 font-semibold uppercase">Min Storage (GB)</label>
                                        <input
                                            type="number"
                                    ...
                                    <div>
                                        <label className="text-slate-500 font-semibold uppercase">Min GPU Tier</label>
                                        <select
                                ...
                                <div className="flex gap-4 pt-1">
                                    <label className="flex items-center gap-1.5 cursor-pointer">
                                        <input
                                            ...
                                            className="rounded border-slate-300 text-indigo-600 text-xs"
                                        />
                                    ...
                                    <label className="flex items-center gap-1.5 cursor-pointer">
                                        <input
                                            ...
                                            className="rounded border-slate-300 text-indigo-600 text-xs"
                                        />
                                        <span className="font-semibold text-slate-700">Laptop / Mobile</span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <button
                                ...
                                disabled={isRanking}
                                className="mt-4 w-full py-2 rounded-xl border border-indigo-200 bg-indigo-50 text-indigo-700 text-xs font-bold hover:bg-indigo-100 transition"
                            >
                ...
                <div className="lg:col-span-7 space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <h2 className="font-bold text-slate-900 text-base">Deterministic Fleet Recommendations</h2>
                        </div>
                        {rankedResults && (
                    ...
                    {!rankedResults ? (
                        <div className="bg-white rounded-2xl border border-slate-200/80 p-12 text-center text-slate-400">
                            ...
                            <h3 className="font-semibold text-slate-700 text-sm">No Active Matching Pipeline Run</h3>
                                    ...
                                    >
                                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pb-3 border-b border-slate-100">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <div className="flex items-center gap-2">
                                                        <h4 className="font-bold text-slate-900 text-sm">{device.brand} {device.model}</h4>
                                                ...
                                                {disqualified ? (
                                                    ...
                                                    <div className="text-right">
                                                        ...
                                                        <span className={`text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full ${
                                                            passes_threshold ? 'bg-emerald-100 text-emerald-800' : 'bg-amber-100 text-amber-800'
                                                        }`}>
                                        ...
                                        {!disqualified && (
                                            <div className="grid grid-cols-5 gap-2 my-3 text-[11px]">
                                                <div>
                                                    <div className="text-slate-400 text-[10px] font-semibold uppercase">CPU (30%)</div>
                                                    <div className="w-full bg-slate-100 rounded-full h-1.5 mt-1 overflow-hidden">
                                                        <div className="bg-indigo-600 h-1.5 rounded-full" style={{ width: `${subscores.cpu * 100}%` }} />
                                                    </div>
                                                    <span className="font-mono text-slate-700 text-[10px]">{Math.round(subscores.cpu * 100)}%</span>
                                                </div>
                                                <div>
                                                    <div className="text-slate-400 text-[10px] font-semibold uppercase">RAM (25%)</div>
                                                    <div className="w-full bg-slate-100 rounded-full h-1.5 mt-1 overflow-hidden">
                                                        <div className="bg-indigo-600 h-1.5 rounded-full" style={{ width: `${subscores.ram * 100}%` }} />
                                                    </div>
                                                    <span className="font-mono text-slate-700 text-[10px]">{Math.round(subscores.ram * 100)}%</span>
                                                </div>
                                                <div>
                                                    <div className="text-slate-400 text-[10px] font-semibold uppercase">Disk (15%)</div>
                                                    <div className="w-full bg-slate-100 rounded-full h-1.5 mt-1 overflow-hidden">
                                                        <div className="bg-indigo-600 h-1.5 rounded-full" style={{ width: `${subscores.storage * 100}%` }} />
                                                    </div>
                                                    <span className="font-mono text-slate-700 text-[10px]">{Math.round(subscores.storage * 100)}%</span>
                                                </div>
                                                <div>
                                                    <div className="text-slate-400 text-[10px] font-semibold uppercase">GPU (20%)</div>
                                                    <div className="w-full bg-slate-100 rounded-full h-1.5 mt-1 overflow-hidden">
                                                        <div className="bg-indigo-600 h-1.5 rounded-full" style={{ width: `${subscores.gpu * 100}%` }} />
                                                    </div>
                                                    <span className="font-mono text-slate-700 text-[10px]">{Math.round(subscores.gpu * 100)}%</span>
                                                </div>
                                                <div>
                                                    <div className="text-slate-400 text-[10px] font-semibold uppercase">Port (10%)</div>
                                                    <div className="w-full bg-slate-100 rounded-full h-1.5 mt-1 overflow-hidden">
                                                        <div className="bg-indigo-600 h-1.5 rounded-full" style={{ width: `${subscores.portability * 100}%` }} />
                                                    </div>
                                                    <span className="font-mono text-slate-700 text-[10px]">{Math.round(subscores.portability * 100)}%</span>
                                                </div>
                                            </div>
                                        )}

                                        {/* Deterministic Objective Rationale Box (Contest Constraint #2) */}
                                        <div className="p-3 rounded-xl bg-slate-50 border border-slate-200/60 text-xs text-slate-700 leading-relaxed mt-2">
                                            <span className="font-bold text-slate-900">Deterministic Rationale:</span> {rationale}
                                        </div>
                                        ...
                                        {!disqualified && (
                                            <div className="mt-3.5 pt-3 border-t border-slate-100 flex items-center justify-between">
                                                ...
                                                <button
                                                    ...
                                                    className="px-4 py-1.5 rounded-xl bg-slate-900 text-white text-xs font-semibold hover:bg-slate-800 transition disabled:opacity-50"
                                                >
